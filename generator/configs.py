...
class GRPOScriptArguments(ScriptArguments):
    ...
    Args:
        ...
        cosine_min_value_wrong (`float`):
            Minimum reward for cosine scaling for incorrect outputs.
        cosine_max_value_wrong (`float`):
            Maximum reward for cosine scaling for incorrect outputs.
        cosine_min_value_correct (`float`):
            Minimum reward for cosine scaling for correct outputs.
        cosine_max_value_correct (`float`):
            Maximum reward for cosine scaling for correct outputs.
        cosine_max_len (`int`):
    ...
    cosine_min_value_wrong: float = field(
        default=0.0,
        metadata={"help": "Minimum reward for incorrect outputs"},
    )
    cosine_max_value_wrong: float = field(
        default=-0.5,
        metadata={"help": "Maximum reward for incorrect outputs"},
    )
    cosine_min_value_correct: float = field(
        default=0.5,
        metadata={"help": "Minimum reward for correct outputs"},
    )
    cosine_max_value_correct: float = field(
        default=1.0,
        metadata={"help": "Maximum reward for correct outputs"},
    )

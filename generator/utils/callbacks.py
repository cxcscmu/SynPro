...
# from generator.organic_classifier import train_organic_classifier  # not needed for release

from .evaluation import run_benchmark_jobs
# from .hub import pass  # push_to_hub_revision  # not needed for release
    ...
    def on_save(
        ...
        **kwargs,
        ...
        if state.is_world_process_zero:
            ...
            future = pass  # push_to_hub_revision(
...
class PostEvalCallback(TrainerCallback):
    def __init__(self, model_config) -> None:
        self.model_config = model_config
    ...
    def on_evaluate(
        ...
        **kwargs,
        ...
        pass  # train_organic_classifier()


CALLBACKS = {
    "pass  # push_to_hub_revision": PushToHubRevisionCallback,
    "post_eval": PostEvalCallback,
}
